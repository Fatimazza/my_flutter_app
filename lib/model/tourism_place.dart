...
var tourismPlaceList = [
  TourismPlace(
      ...
      imageAsset: 'images/wisata-farm-house.jpg',
      imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'images/wisata-bosscha.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'images/wisata-jalan-asia-afrika.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'images/wisata-stone-garden.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAsset: 'images/wisata-taman-film.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAsset: 'images/wisata-museum-geologi.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 20000',
    imageAsset: 'images/wisata-floating-market.png',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAsset: 'images/wisata-kawah-putih.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Rp 20000',
    imageAsset: 'images/wisata-ranca-upas.jpg',
    imageUrls: [
